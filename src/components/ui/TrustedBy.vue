...
const logoModules = import.meta.glob(
  '@/assets/images/pages/HomePage/TrustedBy/*.{svg,png,jpg,jpeg}',
  { eager: true }
);
    ...
    <div class="max-w-6xl mx-auto">
      ...
      >
        ...
        >
          ...
          >
            <div
              class="grid grid-cols-3 md:grid-cols-5 gap-x-8 gap-y-12 items-center justify-items-center"
            >
              <div
                v-for="logo in page"
                :key="logo.id"
                class="h-12 flex items-center justify-center logo-container"
              >
                <img
                  :src="logo.src"
                  :alt="logo.name"
