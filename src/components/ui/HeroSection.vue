  ...
  <section class="relative w-full bg-light-gray overflow-hidden">
      ...
      <div class="hero-content-wrapper">
        ...
        <div class="hero-cta">
          <h2 class="text-h4-panda font-semibold text-panda-black">
            Современная полиграфия для вашего бизнеса
          </h2>
        ...
        <div @click="openVideoPopup" class="hero-video-orb group">
          ...
          >
            <div
              class="w-16 h-16 bg-white/20 rounded-full flex items-center justify-center scale-90 group-hover:scale-100 transition-all duration-300 ease-in-out"
            >
              <svg
    ...
    <Teleport to="body">
      <transition name="popup">
        <div
          v-if="isVideoPopupVisible"
          class="popup-overlay video-popup"
...
.popup-enter-active .video-container,
.popup-leave-active .video-container {
  transition: all 0.3s ease;
}
.popup-enter-from .video-container,
.popup-leave-to .video-container {
