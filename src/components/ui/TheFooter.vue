...
<template>
  <footer class="text-light-gray bg-panda-black text-gray-400 font-medium">
    <div class="max-w-6xl mx-auto px-4 md:px-0 py-16">
      <div
        class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-y-10 md:gap-x-8 items-start"
      >
          ...
          >
            <div>
              ...
              <div>
                ...
                >
                  ...
                  <span
                    ...
                    :class="
                      errors.consent
                        ? 'border-panda-orange'
                        : 'border-dark-gray peer-checked:bg-panda-orange peer-checked:border-panda-orange group-hover:border-gray-500'
                    "
                  >
                    <svg
                      class="w-full h-full text-light-gray transform scale-0 peer-checked:scale-100 transition-transform"
                      viewBox="0 0 14 14"
                      fill="none"
                ...
                <div
                  v-if="errors.consent"
                  class="text-panda-orange text-xs mt-1.5 pl-7"
                >
                  {{ errors.consent }}
                </div>
              </div>
        ...
        <div
          class="hidden md:flex flex-col items-center text-center space-y-4 lg:col-span-2"
        >
        ...
        <div
          class="flex flex-col items-start text-left space-y-8 md:mt-0 md:col-span-2 lg:col-span-1 lg:items-end lg:text-right"
        >
          ...
          <div
            class="flex flex-col items-start lg:items-end gap-1 text-sm w-full"
          >
            <a
              href="tel:+77007257799"
              class="hover:text-panda-orange transition-colors duration-200"
            >
              +7 (700) 725-77-99
            </a>
            <a
