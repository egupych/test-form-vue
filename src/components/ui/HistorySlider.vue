...
const historyEvents = ref([
  ...
  { id: '2016', year: '2016', month: 'Июль', title: 'Формирование команды', description: 'Собрали ядро команды из талантливых дизайнеров и печатников, которые и сегодня с нами.', image: 'https://images.unsplash.com/photo-1552664730-d307ca884978?w=600' }
]);
