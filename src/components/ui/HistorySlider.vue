...
const historyEvents = ref([
  {
    ...
    description:
      'Мы полностью обновили наш сайт, сделав его еще удобнее и современнее для наших любимых клиентов.',
  ...
  },
  {
    ...
    title: 'Корпоратив',
    description:
      'Провели яркий и незабываемый корпоратив, завершив успешный год в кругу нашей дружной команды.',
  ...
  },
  {
    ...
    description:
      'Закупили новое современное оборудование, что позволило нам увеличить производственные мощности и повысить качество продукции.',
  ...
  },
  {
    ...
    description:
      'Открыли наш первый филиал в другом городе, став еще ближе к нашим региональным клиентам.',
  ...
  },
  {
    ...
    description:
      'Red Panda была основана с миссией предоставлять полиграфические услуги высочайшего качества с непревзойденным сервисом.',
  ...
  },
  {
    ...
    description:
      'Заключили знаковый контракт, который стал важной вехой в нашем развитии и подтвердил правильность выбранного пути.',
  ...
  },
  {
    ...
    description:
      'Наша команда выросла, и мы переехали в более просторный и современный офис в центре города.',
  ...
  },
  {
    ...
    description:
      'Впервые представили нашу продукцию на крупной отраслевой выставке, получив признание экспертов и новых клиентов.',
    image: 'https://images.unsplash.com/photo-1560439538-5f568652fa6a?w=600',
  },
  {
    id: '2017',
    year: '2017',
    ...
    description:
      'Внедрили систему онлайн-заказов, сделав процесс сотрудничества с нами еще проще и быстрее.',
...
const visibleEvents = computed(() => {
  return historyEvents.value.slice(
    currentStartIndex.value,
    currentStartIndex.value + DATES_TO_SHOW
  );
});
    ...
    >
      ...
      >
        <div class="event-info">
          ...
          <div class="text-h4-panda font-semibold text-panda-orange mb-15">
            {{ activeEvent.month }}
          </div>
          <h3 class="text-h3-panda font-bold text-panda-black mb-3">
            {{ activeEvent.title }}
          </h3>
          <p class="text-body-panda text-panda-black max-w-md">
