  ...
  <main class="py-10 md:py-25">
    <div class="max-w-6xl mx-auto px-4">
      ...
      <section>
        ...
        <div class="flex flex-col lg:flex-row items-start gap-y-10 gap-x-16 mt-10">
          
          <div class="flex-none lg:w-1/3 space-y-6 text-center lg:text-left pt-8">
            <h2 class="text-h3-panda font-semibold text-panda-black">{{ specialOffer.title }}</h2>
            <p class="text-body-panda text-panda-black">{{ specialOffer.description }}</p>
            <BaseButton to="/gallery" variant="fill-black">Смотреть все</BaseButton>
          </div>
          ...
          <div class="flex-1 grid grid-cols-1 sm:grid-cols-3 gap-6 items-start">
            ...
            >
              <div class="relative transition-transform duration-300 ease-out group-hover:-translate-y-5">
                ...
                <div class="text-center space-y-4 bg-light-gray rounded-2xl p-6">
                  <img :src="product.image" :alt="product.name" class="mx-auto h-48 object-contain">
                  <div class="">
                    <h3 class="text-h5-panda font-semibold text-panda-black">{{ product.name }}</h3>
                    <p class="text-body-panda font-bold text-panda-black mt-1">{{ product.price }} ₸</p>
                  </div>
                </div>
