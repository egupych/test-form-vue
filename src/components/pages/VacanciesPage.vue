          ...
          >
            <div class="flex-grow">
              <div class="flex justify-between items-start">
                <h3
                  class="text-h4-panda font-bold text-panda-black leading-tight"
                >
                  {{ vacancy.title }}
                </h3>
              ...
              <div class="mb-4">
                ...
                <div class="text-gray-800 text-body-panda leading-relaxed">
                  {{ vacancy.conditions }}
                </div>
              </div>
              <div class="mb-4">
                ...
                <ol
                  class="list-decimal list-inside text-gray-800 text-body-panda leading-relaxed space-y-1"
                >
                  <li
                    v-for="(resp, index) in vacancy.responsibilities"
                    :key="index"
                    class="pl-1"
                    v-html="resp"
                  ></li>
