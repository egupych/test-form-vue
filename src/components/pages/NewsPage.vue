...
const news = ref({
  ...
  description: 'вв8-я международная выставка рекламы, полиграфии, технологий и материалов в Алмате стала для нас источником вдохновения и новых идей. Мы изучили передовые технологии, наладили контакты с партнерами и готовы внедрять лучшие решения для наших клиентов.',
  date: '2025-05-28',
  images: [
