...
<template>
  <main>
    <div class="main-container">
        ...
        <p class="text-xl text-dark-gray leading-relaxed mb-6">Здесь вы найдете наши продукты и услуги. В будущем здесь будут динамически загружаться товары с ценами и возможностью добавления в корзину.</p>
